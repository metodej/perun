...
public interface ResourcesManagerBl {
	...
	/**
	 * Returns all members who can access the resource and also valid in at least one group associated to the resources.
	 *
	 * @param perunSession
	 * @param resource
	 * @return list of members assigned to the resource
	...
	/**
	 * Get all users, who can assess the resource and not expired in at least one group.
	 *
	 * @param sess
	 * @param resource
	 * @return list of users
